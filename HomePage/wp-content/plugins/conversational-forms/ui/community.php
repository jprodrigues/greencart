<div class="qcformbuilder-editor-header">
	<ul class="qcformbuilder-editor-header-nav">
		<li class="qcformbuilder-editor-logo">
			...
			<?php echo esc_html__('Chatbot Form Builder', 'qcformbuilder-forms'); ?>
		</li>
...
<div class="qcformbuilder-editor-header qcformbuilder-editor-subnav">
	<ul class="qcformbuilder-editor-header-nav ajax-trigger" data-load-class="spinner" data-request="<?php echo esc_url( WFBCORE_EXTEND_URL ) . 'channels/community/?version=' . esc_attr( WFBCORE_VER ); ?>" data-target="#main-cat-nav" data-target-insert="append" data-template="#nav-items-tmpl" data-event="loadchannels" data-autoload="true" id="main-cat-nav" >
	</ul>
</div>
